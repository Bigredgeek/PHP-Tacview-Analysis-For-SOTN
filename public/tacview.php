...
class tacview
{
	...
	{
		// Open language file - use absolute path with __DIR__
		$language_path = __DIR__ . "/languages/tacview_" . $aLanguage . ".php";
		
		// Load language file - it defines $_LANGUAGE variable
		if (file_exists($language_path)) {
			include $language_path;
			// After include, $_LANGUAGE variable is available in this scope
